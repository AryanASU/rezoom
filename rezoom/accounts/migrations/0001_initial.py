# Generated by Django 5.2.6 on 2025-09-21 01:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('USER', 'User'), ('HR', 'HR'), ('EMP', 'Employee')], default='USER', max_length=8)),
                ('google_sub', models.CharField(blank=True, max_length=128, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visa_status', models.CharField(blank=True, max_length=64)),
